...
export default function ProjectCard({
  ...
  let classes = "flex rounded-xl sm:w-[25rem] sm:h-[15rem] w-[20rem] h-[13rem] content-center flex-col items-center justify-center m-3 text-center  shadow-xl border-2 border-[#333]/[0.1] cursor-pointer md:hover:scale-110"
