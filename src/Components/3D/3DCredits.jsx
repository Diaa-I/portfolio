export default function ThreeDimensionalCredits({}) {
  /*
  "Computer with a table" by Youssef Hamdan is licensed under CC BY 4.0. Link: https://www.fab.com/listings/37652522-c45e-486c-8da0-ba01ed632a05
    Frame: https://www.fab.com/listings/b103a5ef-47f0-4d76-a0ea-dad8aed51171
...
<a href="https://www.flaticon.com/free-icons/video" title="video icons">Video icons created by Freepik - Flaticon</a> 
  ...
  */
  ...
  return (
    <>
      <h2 className="lg:text-3xl font-extrabold text-center my-1">
        Credits & Resources for the 3D section
      </h2>
      <ul className="text-center space-y-2">
        <li>
          <a
            href="https://www.fab.com/listings/37652522-c45e-486c-8da0-ba01ed632a05"
            target="_blank"
            className="text-blue-500 hover:text-blue-700 hover:underline transition-colors duration-200"
          >
            "Computer with a table" by Youssef Hamdan is licensed under CC BY
            4.0
          </a>
        </li>
        <li>
          <a
            href="https://www.fab.com/listings/b103a5ef-47f0-4d76-a0ea-dad8aed51171"
            target="_blank"
            className="text-blue-500 hover:text-blue-700 hover:underline transition-colors duration-200"
          >
            "Damaged Picture Frame" by Quixel Megascans
          </a>
        </li>
        <li>
          <a
            href="https://www.fab.com/listings/1e4fb2a0-7cf7-424d-8751-54e62a5ed03a"
            target="_blank"
            className="text-blue-500 hover:text-blue-700 hover:underline transition-colors duration-200"
          >
            Wooden Flooring by NoblesseOblige-No.1
          </a>
        </li>
        <li>
          <a
            href="https://www.fab.com/listings/42d05d58-3131-4afc-9f60-4920b5a86536"
            target="_blank"
            className="text-blue-500 hover:text-blue-700 hover:underline transition-colors duration-200"
          >
            TV by Oobe-Xr Srl
        ...
        <li>
          <a
            href="https://www.fab.com/listings/e2f69285-c695-4aa8-851c-1b6492b79b74"
            target="_blank"
            className="text-blue-500 hover:text-blue-700 hover:underline transition-colors duration-200"
          >
